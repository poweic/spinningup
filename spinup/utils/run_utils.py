...
def call_experiment(exp_name, thunk, seed=0, num_cpu=1, data_dir=None, 
    ...
    output_dir = os.path.join(os.getcwd(), logger_kwargs['output_dir'])
    plot_cmd = 'python -m spinup.run plot '+ output_dir
    plot_cmd = colorize(plot_cmd, 'green')

    test_cmd = 'python -m spinup.run test_policy '+ output_dir
